# Sevenfold Seed to 108:6 Matrix Bridge v0.1

## Structural proposal

The seven Seed positions do not divide the 108 internal states into seven
groups. Instead, the center is associated with the complete 108-state local
processor and the six surrounding positions are associated with the six
boundary gates. This directly reflects the existing 108:6 architecture.

Consciousness labels the directing or localizing role of the central processor,
while Ether labels its proposed relational medium. Neither is introduced as a
...
- whether Consciousness and Ether are independent variables, dual aspects, or
  ontological labels;
- which dynamics, if any, select a preferred elemental-to-spatial frame;
- whether the six modes alter boundary coupling, flux, phase, or another
  observable;
- whether Metal and Crystal behave as fundamental modes or material outcomes.
