...
| Toroidal circulation | Smooth positive-Jacobian annular bends implemented on globally collision-audited routing | Quarter bends preserve the annular flux profile, match adjacent straight fields, retain positive Jacobian, and stay inside certified global envelopes. Unified whole-network field sampling is the final kinematic gate before dynamics. |
