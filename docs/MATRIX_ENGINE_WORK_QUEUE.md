...
| Toroidal circulation | Smooth positive-Jacobian annular bends implemented on globally routed edges | Bend fields are locally valid and collision-certified for nonincident edges. Same-face incident connectors still converge toward a common channel annulus and require a disjoint fan-out or separated-channel construction before a unified field sampler. |
