...
| Toroidal circulation | Connected node volumes plus annular Piola connector implemented; rectangular-port topology no-fit identified | Purely poloidal annulus-to-cut connectors preserve flux and match the toroidal target field. Junction external ports must be redesigned as annuli, then globally embedded before dynamics. |
